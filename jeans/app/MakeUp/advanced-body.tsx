...
const editedImages = [
  require('@/assets/images/데모이미지/데모이지미1-머리숱.jpg'), // 인덱스 0 - V라인 적용
  require('@/assets/images/데모이미지/데모이지미2-머리숱.jpg'), // 인덱스 1 - V라인 적용
  require('@/assets/images/데모이미지/데모이지미3-머리숱.jpg'), // 인덱스 2 - V라인 적용
  require('@/assets/images/데모이미지/데모이지미4-머리숱.jpg'), // 인덱스 3 - V라인 적용
];
