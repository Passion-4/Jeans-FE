...
> = {
  "/Home/main-page": [
    ...
    { x: 272, y: 85, width: 80, height: 55, text: "공유 화면으로 넘어갑니다." },
    { x: 10, y: 175, width: 75, height: 63, text: "친구와 공유한 사진을 확인할 수 있어요!" },
    { x: 10, y: 275, width: 180, height: 180, text: "사진을 누르면 사진에 대한 정보와 친구와의 대화를 볼 수 있어요!" },
  ],
  "/Makeup/Makeup0": [
    { x: 10, y: 298, width: 340, height: 70, text: "나의 최고로 잘 나온 사진을 찾을 수 있어요." },
