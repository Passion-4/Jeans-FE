...
> = {
  "/Home/main-page": [
    ...
    { x: 11, y: 291, width: 170, height: 170, text: "사진을 누르면 사진에 대한 정보와 친구와의 대화를 볼 수 있어요." },
    { x: 25, y: 660, width: 105, height: 60, text: "어느 페이지에 있어도 현재 페이지로 돌아와요." },
    { x: 125, y: 625, width: 110, height: 107, text: "원하는 기능을 목소리로 물어보면 해당하는 페이지로 이동해요." },
    { x: 230, y: 660, width: 105, height: 60, text: "사진 편집을 하는 페이지로 이동해요." },
  ],
  "/Home/photo-detail": [
    ...
    { x: 10, y: 560, width: 225, height: 63, text: "각 친구와 공유한 사진을 확인할 수 있어요." },
    { x: 232, y: 560, width: 121, height: 63, text: "사진을 누르면 사진에 대한 정보와 친구와의 대화를 볼 수 있어요." },
  ],
