...
> = {
  "/Home/Mainpage": [
    { x: 200, y: 15, width: 50, height: 45, text: "검색 버튼을 누르면 친구를 검색할 수 있습니다." },
    { x: 255, y: 15, width: 50, height: 45, text: "친구 버튼을 누르면 친구 설정을 변경할 수 있습니다." },
    { x: 300, y: 15, width: 50, height: 45, text: "설정 버튼을 누르면 앱 설정을 변경할 수 있습니다." },
  ],
  "/Friend/list": [
